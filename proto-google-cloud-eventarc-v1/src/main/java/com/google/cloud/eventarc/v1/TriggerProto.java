  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ior.proto\032\031google/api/resource.proto\032\037google/protobuf/timestamp.proto\"\235\005\n"
          + "\007Trigger\022\021\n"
          ...
          + "\037eventarc.googleapis.com/Trigger\022:projects/{projec"
          + "t}/locations/{location}/triggers/{trigger}*\010triggers2\007trigger\"9\n"
          + "\013EventFilter\022\026\n"
          + "\tattribute\030\001 \001(\tB\003\340A\002\022\022\n"
          + "\005value\030\002 \001(\tB\003\340A\002\"T\n"
          + "\013Destination\0227\n"
          + "\tcloud_run\030\001 \001(\0132\".google.cloud.eventarc.v1.CloudRunH\000B\014\n\n"
          + "descriptor\"O\n"
          + "\tTransport\0222\n"
          ...
          + "\034com.google.cloud.eventarc.v1B\014TriggerProtoP\001Z@google.golang.org/ge"
          + "nproto/googleapis/cloud/eventarc/v1;eventarc\352Ak\n"
          + "+cloudfunctions.googleapis.com/C"
          + "loudFunction\022<projects/{project}/locations/{location}/functions/{function}\352AY\n"
          + "!iam.googleapis.com/ServiceAccount\0224projec"
          + "ts/{project}/serviceAccounts/{service_account}\352A\037\n"
          + "\032run.googleapis.com/Service\022\001*b\006proto3"
    };
    descriptor =
